...
لوحة المشروع الأساسية **Dashboard Only**، مع مسارات تنبيه منفصلة ومقيدة:

- يعرض النتائج في صفحة الويب.
- يحفظ الإشارات والنتائج والمعايرة داخل GitHub.
- يرسل مسار الاتجاه الكلاسيكي إشعارات Telegram فقط عند وجود CALL أو PUT مؤكدة.
- لا يرسل WAIT، ولا يكرر الإشارة نفسها، ولا يرسل من تشغيل التحقق البرمجي قبل السوق.
- لا ينفذ أوامر تداول آلية.
- لا يغير أوزان النموذج قبل اكتمال عينة ناضجة.

## مسار الاتجاه الكلاسيكي للأسهم الكبرى

- يحلل السهم الأساسي فقط على اليومي والساعة و15 دقيقة.
- يستخدم اتجاه داو والدعم والمقاومة وخطوط الاتجاه والمتوسطات البسيطة والحجم
  والاختراق/إعادة الاختبار والنماذج والشموع الكلاسيكية.
- لا تدخل بيانات عقد الأوبشن أو Greeks أو Flow أو RSI أو MACD أو VWAP أو ICT/SMC
  في قرار CALL أو PUT.
- لا يصدر CALL أو PUT إلا عند اتفاق الأطر الثلاثة؛ وما عدا ذلك يبقى WAIT بلا تنبيه.
- يتحقق من قابلية السهم للأوبشن عبر OCC، ثم يجلب شموع السهم من شبكة مزودين احتياطية.
- فشل الأسعار يسجل كخطأ بيانات ويفشل التشغيل بأمان؛ لا يتحول إلى WAIT مضلل.
